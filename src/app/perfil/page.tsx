...
import { User, Calendar, TrendingUp, Settings, LogOut } from "lucide-react";
...
export default function ProfilePage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-600 via-purple-700 to-pink-600 px-6 py-8 pb-24" suppressHydrationWarning>
            ...
            <div className="mb-6 space-y-3">
                ...
                <button className="flex w-full items-center justify-between rounded-2xl bg-white/15 p-4 backdrop-blur-md border border-white/20 transition-all hover:bg-white/25">
                    <div className="flex items-center space-x-3">
                        <Settings className="h-5 w-5 text-white" />
                        <span className="font-semibold text-white drop-shadow">Preferencias</span>
                    </div>
                </button>
            ...
            <div className="rounded-2xl bg-white/10 p-6 backdrop-blur-md border border-white/20">
                ...
                <p className="text-sm text-white/80">
                    Plataforma de diagnóstico integral diseñada para evaluar tu bienestar en 6 dimensiones clave.
                </p>
