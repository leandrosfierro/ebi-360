  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-gradient-to-br from-purple-600 via-purple-700 to-pink-600">
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-10">
        ...
        <p className="mb-12 max-w-sm text-center text-lg text-white drop-shadow">
        ...
        <Link
          href="/diagnostico"
          className="group flex w-full max-w-sm items-center justify-center rounded-2xl bg-white px-8 py-5 text-lg font-bold text-purple-700 shadow-glass-lg transition-all hover:scale-105 hover:shadow-2xl active:scale-95"
        >
...
function FeatureCard({ icon, text, bgColor }: { icon: string; text: string; bgColor: string }) {
  return (
    <div className={`flex items-center space-x-4 rounded-2xl ${bgColor} border border-white/20 p-4 backdrop-blur-md`}>
