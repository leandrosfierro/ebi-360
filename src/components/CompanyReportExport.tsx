...
export function CompanyReportExport({
    ...
    const exportToPDF = async () => {
        ...
        if (logoUrl) {
            try {
                pdf.addImage(logoUrl, "PNG", 20, 15, 40, 20);
            } catch (e) {
        ...
        const summaryText = `Este reporte presenta un análisis agregado del bienestar organizacional basado en ${metrics.completedSurveys} encuestas completadas de ${metrics.employeesCount} colaboradores.`;
        ...
        try {
            ...
            pdf.text("Gráficos no disponibles en esta versión", pageWidth / 2, 100, { align: "center" });
        }
